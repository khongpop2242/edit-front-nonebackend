...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      {/* Features */}
<section className="features features--compact">   {/* เพิ่ม features--compact */}
  <div className="container">
    <div className="features-grid">
      <div className="feature-card">
        <div className="icon-ring"><i className="fas fa-truck"></i></div>
        <h3 className="feature-title">บริการจัดส่ง</h3>
      </div>
      <div className="feature-card">
        <div className="icon-ring"><i className="fas fa-check"></i></div>
        <h3 className="feature-title">สินค้าราคาโรงงาน</h3>
      </div>
      <div className="feature-card">
        <div className="icon-ring"><i className="fas fa-sync-alt"></i></div>
        <h3 className="feature-title">รับประกัน 1 ปี</h3>
      </div>
    </div>
  </div>
</section>
