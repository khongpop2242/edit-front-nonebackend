...
export default function Register() {
  ...
  <img src="/logo-login-kaokai.png" alt="kaokai" className="register-logo-img" />
</div>
      <div className="register-container">
        ...
        <form onSubmit={onSubmit} className="register-form">
          ...
          <input type="password" placeholder="พิมพ์รหัสผ่านอีกครั้ง" value={confirm} onChange={(e)=>setConfirm(e.target.value)} required />
          <div className="terms">
            <label>
